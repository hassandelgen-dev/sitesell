...
const HOME_TRANSLATIONS = {
  ru: {
    ...
    ".hero-main .badge": "Сайт, который дожимает клиента после холодного звонка",
    ".hero-main h1": { html: "После прозвона клиент должен увидеть, что вам можно доверять.<span>Делаю сайты для магазинов, кафе и СТО, которые переводят интерес в заявку за 1–2 минуты</span>" },
    ".hero-main .lead": "Менеджер отправляет ссылку сразу после звонка, клиент открывает сайт и быстро понимает: чем вы полезны, сколько это стоит и как оставить контакт без лишних шагов.",
    ".hero-actions .btn[href='#lead-form']": "Оставить заявку",
    "#calculator .section-kicker": "Быстрый просчет",
    "#calculator h2": "Рассчитайте сайт под ваш бизнес за 1 минуту",
    "#calculator .section-lead": "Выберите тип проекта и получите ориентир по бюджету и срокам. После заявки отправлю персональный план запуска под вашу нишу.",
    "#social .section-kicker": "Социальное доказательство",
    "#social h2": "Что говорят клиенты после запуска",
    ...
    "#lead-form .cta-grid > div p": "На коротком созвоне разберём ваш текущий прозвон, путь клиента и соберём понятный сценарий сайта, который прогревает и приводит заявки.",
  ...
  uk: {
    ...
    ".hero-main .badge": "Сайт для бізнесу, який продовжує розмову після дзвінка",
    ".hero-main h1": { html: "Поки у вас немає сайту, частина клієнтів іде до конкурентів.<span>Запускаю сайт за 3–5 днів із фокусом на перші заявки в перший тиждень</span>" },
    ".hero-main .lead": "Після холодного дзвінка клієнт уже “теплий”. Йому потрібен чіткий екран: проблема, рішення, докази та один крок — залишити заявку.",
    ...
    "#social h2": "Купують не сайт — купують впевненість у результаті",
    "#faq .section-kicker": "Відповіді на запитання",
    "#faq h2": "Поширені запитання",
    "#lead-form .section-kicker": "Старт проєкту",
    "#lead-form h2": "Залиште заявку — зв'яжусь протягом 10 хвилин",
    "#lead-form .cta-grid > div p": "Коротко розберемо вашу нішу і покажу, який сайт найшвидше приведе заявки саме у вашому випадку.",
  ...
  en: {
    ...
    ".hero-main .badge": "A business website that continues your sales call",
    ".hero-main h1": { html: "Without a website, part of your clients goes to competitors.<span>I launch your site in 3–5 days focused on first leads in week one</span>" },
    ".hero-main .lead": "After a cold call, the prospect is already warm. They need one clear screen: problem, solution, proof, and one action — leave a request.",
    ...
    "#social h2": "People do not buy websites — they buy confidence in results",
    "#faq .section-kicker": "Answers",
    "#faq h2": "Frequently asked questions",
    "#lead-form .section-kicker": "Project start",
    "#lead-form h2": "Leave a request — I will call you within 10 minutes",
    "#lead-form .cta-grid > div p": "We will quickly review your niche and show which website format can bring leads fastest in your case.",
