...
const LOCALE = {
  ru: {
    ...
    fillContact: "Укажите имя и телефон.",
  ...
  uk: {
    ...
    fillContact: "Вкажіть ім'я та телефон.",
...
const HOME_TRANSLATIONS = {
  ru: {
    ...
    ".nav-links a[href='#cases']": "Что получите",
    ".nav-links a[href='#pain-now']": "Проблема",
    ".nav-links a[href='#calculator']": "Калькулятор",
    ".nav-links a[href='#social']": "Доверие",
    ".nav-links a[href='#process']": "Этапы",
    ".nav-links a[href='#contacts']": "Контакты",
    ".hero-main h1": "Вы теряете клиентов каждый день без сайта",
    ".hero-main .lead": "Сделаем сайт под ваш бизнес за 3–5 дней, который начнёт приносить заявки и клиентов",
    ".hero-actions .btn[href='#lead-form']": "Получить сайт под ключ",
    "#calculator .calc-intro-kicker": "Блок про деньги",
    "#calculator .calc-intro-title": "Сколько клиентов вы теряете прямо сейчас",
    "#calculator .calc-main-kicker": "Быстрый просчет",
    "#calculator .calc-main-title": "Рассчитайте стоимость сайта за 1 минуту",
    "#social h2": "Почему нам доверяют",
    "#lead-form h2": "Оставьте заявку",
    "#lead-form .cta-grid > div p": "Мы свяжемся с вами и покажем, как сайт может приносить клиентов вашему бизнесу",
    "#leadForm input[name='name']": { placeholder: "Имя" },
    "#leadForm input[name='contact']": { placeholder: "Телефон" },
    "#leadForm button[type='submit']": "Получить сайт",
  ...
  uk: {
    ...
    ".nav-links a[href='#cases']": "Що отримаєте",
    ".nav-links a[href='#pain-now']": "Проблема",
    ".nav-links a[href='#calculator']": "Калькулятор",
    ".nav-links a[href='#social']": "Довіра",
    ".nav-links a[href='#process']": "Етапи",
    ".nav-links a[href='#contacts']": "Контакти",
    ".hero-main .badge": "Сайт, який перетворює інтерес на заявки та продажі",
    ".hero-main h1": { html: "Ваш сайт має пояснювати цінність бізнесу за перші секунди.<span>Створюю сайти для магазинів, кафе та СТО, які підсилюють довіру й приводять клієнтів</span>" },
    ".hero-main .lead": "Коли на сайті все зрозуміло: вигода, приклади, гарантії та простий наступний крок — людина швидше приймає рішення і залишає заявку.",
    ".hero-actions .btn[href='#lead-form']": "Залишити заявку",
    "#calculator .calc-intro-kicker": "Блок про гроші",
    "#calculator .calc-intro-title": "Скільки клієнтів ви втрачаєте прямо зараз",
    "#calculator .calc-main-kicker": "Швидкий прорахунок",
    "#calculator .calc-main-title": "Розрахуйте вартість сайту за 1 хвилину",
    "#calculator .section-lead": "Оберіть параметри та отримайте орієнтир за бюджетом і строками. Після заявки запропоную оптимальний формат під ваш бізнес.",
    "#social .section-kicker": "Соціальний доказ",
    "#social h2": "Результати, які відзначають клієнти",
    "#faq .section-kicker": "Відповіді на запитання",
    "#faq h2": "Поширені запитання",
    "#lead-form .section-kicker": "Старт проєкту",
    "#lead-form h2": "Залиште заявку — підготую структуру сайту під вашу нішу",
    "#lead-form .cta-grid > div p": "На короткому дзвінку розберемо ваш бізнес, аудиторію та цілі, після чого запропоную структуру сайту, що підсилює довіру і конверсію.",
    "#leadForm input[name='name']": { placeholder: "Ваше ім'я" },
    "#leadForm input[name='contact']": { placeholder: "Телефон" },
    "#leadForm button[type='submit']": "Залишити заявку",
  ...
  en: {
    ...
    ".nav-links a[href='#cases']": "What you get",
    ".nav-links a[href='#pain-now']": "Problem",
    ".nav-links a[href='#calculator']": "Calculator",
    ".nav-links a[href='#social']": "Trust",
    ".nav-links a[href='#process']": "Process",
    ".nav-links a[href='#contacts']": "Contacts",
    ".hero-main .badge": "A website that turns interest into leads and sales",
    ".hero-main h1": { html: "Your website should communicate business value in the first seconds.<span>I build websites for stores, cafes, and auto services that increase trust and convert visitors into clients</span>" },
    ".hero-main .lead": "When your website is clear—benefits, proof, guarantees, and one obvious next step—people decide faster and leave a request with confidence.",
    ".hero-actions .btn[href='#lead-form']": "Leave request",
    "#calculator .calc-intro-kicker": "Money block",
    "#calculator .calc-intro-title": "How many clients you are losing right now",
    "#calculator .calc-main-kicker": "Quick estimate",
    "#calculator .calc-main-title": "Estimate your website cost in 1 minute",
    "#calculator .section-lead": "Choose your parameters and get a budget and timeline estimate. After your request, I will suggest the best format for your business.",
    "#social .section-kicker": "Social proof",
    "#social h2": "Results clients notice after launch",
    "#faq .section-kicker": "Answers",
    "#faq h2": "Frequently asked questions",
    "#lead-form .section-kicker": "Project start",
    "#lead-form h2": "Leave a request — I will prepare a site structure for your niche",
    "#lead-form .cta-grid > div p": "On a short call, we review your business, audience, and goals, then I suggest a website structure that improves trust and conversion.",
    "#leadForm input[name='name']": { placeholder: "Your name" },
    "#leadForm input[name='contact']": { placeholder: "Phone" },
    "#leadForm button[type='submit']": "Leave request",
