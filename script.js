...
const HOME_TRANSLATIONS = {
  ru: {
    ...
    ".nav-links a[href='#pain-now']": "Почему сейчас",
    ".nav-links a[href='#why']": "Почему работает",
    ".nav-links a[href='#process']": "Этапы",
    ".nav-links a[href='#contacts']": "Контакты",
    ".hero-main .badge": "Сайт, который превращает интерес в заявки и продажи",
    ".hero-main h1": { html: "Ваш сайт должен объяснять ценность бизнеса за первые секунды.<span>Создаю сайты для магазинов, кафе и СТО, которые усиливают доверие и приводят клиентов в работу</span>" },
    ".hero-main .lead": "Когда на сайте всё ясно: выгода, примеры, гарантии и понятный следующий шаг — человек принимает решение быстрее и оставляет заявку без сомнений.",
    ".hero-actions .btn[href='#lead-form']": "Оставить заявку",
    "#calculator .section-kicker": "Быстрый просчет",
    "#calculator h2": "Рассчитайте стоимость сайта за 1 минуту",
    "#calculator .section-lead": "Выберите параметры и получите ориентир по бюджету и срокам. После заявки предложу оптимальный формат под ваш бизнес.",
    "#social .section-kicker": "Социальное доказательство",
    "#social h2": "Результаты, которые отмечают клиенты",
    "#faq .section-kicker": "Ответы на вопросы",
    "#faq h2": "Частые вопросы",
    "#lead-form .section-kicker": "Старт проекта",
    "#lead-form h2": "Оставьте заявку — соберу структуру сайта под вашу нишу",
    "#lead-form .cta-grid > div p": "На коротком созвоне разберём ваш бизнес, аудиторию и цели, после чего предложу структуру сайта, которая усиливает доверие и конверсию.",
    "#leadForm input[name='name']": { placeholder: "Ваше имя" },
    "#leadForm input[name='contact']": { placeholder: "Телефон" },
    "#leadForm button[type='submit']": "Оставить заявку",
  ...
  uk: {
    ...
    ".nav-links a[href='#pain-now']": "Чому зараз",
    ...
    "#calculator h2": "Розрахуйте вартість сайту за 1 хвилину",
  ...
  en: {
    ...
    ".nav-links a[href='#pain-now']": "Why now",
    ...
    "#calculator h2": "Estimate your website cost in 1 minute",
