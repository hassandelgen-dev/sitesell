...
const HOME_TRANSLATIONS = {
  ru: {
    ...
    ".hero-main .badge": "Лендинг продолжает ваш разговор после холодного звонка",
    ".hero-main h1": { html: "Нет сайта — теряете клиентов каждый день.<span>Сделаю сайт за 3–5 дней и приведу первые заявки уже в первую неделю</span>" },
    ".hero-main .lead": "Если клиент после звонка заходит на страницу и сразу видит свою боль, срок запуска и понятный следующий шаг, заявка приходит быстрее. Поэтому здесь только одно действие — оставить контакты и получить план запуска.",
    ...
    "#social h2": "Люди покупают не сайт — люди покупают уверенность",
    "#faq .section-kicker": "Ответы на вопросы",
    "#faq h2": "Частые вопросы",
    "#lead-form .section-kicker": "Старт проекта",
    "#lead-form h2": "Оставьте заявку — перезвоним в течение 10 минут",
    "#lead-form .cta-grid > div p": "Покажем, как сайт под вашу нишу может приносить клиентов уже в первую неделю после запуска.",
  ...
  uk: {
    ...
    ".hero-main .badge": "Лендінг продовжує вашу розмову після холодного дзвінка",
    ".hero-main h1": { html: "Немає сайту — втрачаєте клієнтів щодня.<span>Зроблю сайт за 3–5 днів і приведу перші заявки вже у перший тиждень</span>" },
    ".hero-main .lead": "Якщо клієнт після дзвінка заходить на сторінку і одразу бачить свій біль, строк запуску та зрозумілий наступний крок, заявка приходить швидше. Тому тут лише одна дія — залишити контакти.",
    ...
    "#social h2": "Люди купують не сайт — люди купують впевненість",
    "#faq .section-kicker": "Відповіді на запитання",
    "#faq h2": "Поширені запитання",
    "#lead-form .section-kicker": "Старт проєкту",
    "#lead-form h2": "Залиште заявку — передзвонимо протягом 10 хвилин",
    "#lead-form .cta-grid > div p": "Покажемо, як сайт у вашій ніші може приносити клієнтів уже в перший тиждень після запуску.",
  ...
  en: {
    ...
    ".hero-main .badge": "The landing page continues your cold-call message",
    ".hero-main h1": { html: "No website means losing clients every day.<span>I will launch your site in 3–5 days and bring first leads in the first week</span>" },
    ".hero-main .lead": "When a prospect visits right after the call and instantly sees their pain, timeline, and next step, conversion grows. So there is one action only — leave your contact details.",
    ...
    "#social h2": "People do not buy a website — they buy confidence",
    "#faq .section-kicker": "Answers",
    "#faq h2": "Frequently asked questions",
    "#lead-form .section-kicker": "Project start",
    "#lead-form h2": "Leave a request — we call back within 10 minutes",
    "#lead-form .cta-grid > div p": "We will show how your niche-focused website can start bringing clients in the first week after launch.",
