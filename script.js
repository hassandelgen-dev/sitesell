...
const HOME_TRANSLATIONS = {
  ru: {
    ...
    ".hero-main h1": { html: "Пока у вас нет сайта, часть клиентов уходит к конкурентам.<span>Запускаю сайт за 3–5 дней с фокусом на первые заявки в первую неделю</span>" },
    ".hero-main .lead": "После холодного звонка человек уже “тёплый”. Ему нужен ясный экран: проблема, решение, доказательства и один понятный шаг — оставить заявку.",
