...
const HOME_TRANSLATIONS = {
  ru: {
    ...
    ".hero-main .badge": "Сайт для бизнеса, который продолжает разговор после звонка",
    ".hero-main h1": { html: "Уже вложились в сайт, а заявок всё равно мало?<span>Соберу сайт за 3–5 дней с понятной структурой, чтобы вы не теряли бюджет второй раз</span>" },
    ".hero-main .lead": "Этот лендинг закрывает боль именно заказчика сайта: когда прошлый подрядчик сорвал сроки, не объяснил логику и не дал результата. Здесь всё прозрачно: что делаем, когда и зачем.",
    ...
    "#social h2": "Покупают не сайт — покупают уверенность в результате",
    "#faq .section-kicker": "Ответы на вопросы",
    "#faq h2": "Частые вопросы",
    "#lead-form .section-kicker": "Старт проекта",
    "#lead-form h2": "Оставьте заявку — свяжусь в течение 10 минут",
    "#lead-form .cta-grid > div p": "Коротко разберём вашу нишу и покажу, какой сайт даст заявки быстрее всего именно в вашем случае.",
  ...
  uk: {
    ...
    ".hero-main h1": { html: "Вже вклались у сайт, а заявок все одно мало?<span>Запускаю сайт за 3–5 днів із чіткою структурою, щоб ви не втратили бюджет вдруге</span>" },
    ".hero-main .lead": "Цей лендинг закриває біль саме замовника сайту: коли попередній підрядник зірвав строки, не пояснив логіку і не дав результату. Тут усе прозоро: що робимо, коли і навіщо.",
  ...
  en: {
    ...
    ".hero-main h1": { html: "Already paid for a website, but still not enough leads?<span>I launch your site in 3–5 days with clear conversion structure so you do not waste budget again</span>" },
    ".hero-main .lead": "This landing page addresses the website buyer's pain directly: missed deadlines, unclear process, and weak outcomes. The process is transparent: what we do, when, and why.",
